    ...
    return (
        <main className='mt-4'>
            <div className="container">
                ...
                {/* Popular Categories */}
                <h3 className="md-3">Popular Categories <a href="#" className='float-end btn btn-dark '>View all Categories <i class="fa-solid fa-arrow-right-to-bracket"></i></a></h3>
                <div className="row mb-4">
                    ...
                    <div className="col-12 col-md-3 mb-4">
                        <div className="card shadow">
                            ...
                            <div className="card-body">
                                <h4 className="card-title">Categories Title</h4>
                            </div>
                ...
                {/* Trending Products  */}
                <h3 className="md-3">Trending Product <a href="#" className='float-end btn btn-dark '>View all Trending Products <i class="fa-solid fa-arrow-right-to-bracket"></i></a></h3>
                <div className="row mb-4">
                ...
                {/* Popular Retailer */}
                <h3 className="md-3">Popular Retailer <a href="#" className='float-end btn btn-dark '>View all Retailer <i class="fa-solid fa-arrow-right-to-bracket"></i></a></h3>
                <div className="row mb-4">
                    ...
                    <div className="col-12 col-md-3 mb-4">
                        <div className="card shadow">
                            <img src={logo} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h4 className="card-title">Retailer Name</h4>
                            </div>
                            <div className="card-footer">
                                Categories : <a href="#">Redmi</a>,<a href="#">Oppo</a>
                            </div>
                        </div>
                    </div>
                    {/* Retailer Box End*/}
